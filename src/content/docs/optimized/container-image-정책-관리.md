---
title: "Container Image 정책을 관리한다"
description: "**Container Image 스캔 및 차단**(ECR + Inspector)과 **컨테이너 이미지 취약점 판단 및 관리**(EventBridge + SNS 알림)는 취약점을 탐지하고 담당자에게 알리는 역할을 한다. 하지만 두 단계 모두 **레지스트리와 알림 수준에서"
phase: "Optimized"
domain: "Pod 보안"
difficulty: "★★★"
owner: "장해윤"
